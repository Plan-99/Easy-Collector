...
| OMY | - [ ] 01 | `omy-01-hardware.png` | OMY-F3M 본체 + RH-P12-RN 그리퍼 + RealSense D405 + 온보드 `/dev/ttyAMA*` 버스 확인 |
| OMY | - [ ] 02 | `omy-02-online.png` | OMY 카드 ONLINE + RobotPendant 조인트 슬라이더 (6-DOF + 그리퍼) |
| OMY | - [ ] 03 | `omy-03-ssh-fields.png` | 로봇 등록 화면의 SSH Host / SSH User / SSH Port 입력 필드 (원격 SSH 운용) |
