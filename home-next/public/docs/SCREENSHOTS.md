...
| Replay | - [ ] 02 | `replay-02-replay-panel.png` | Replay 헤더 — Action Type(qaction/ee_delta_action) + Capture Episode + Target Dataset |
| Replay | - [ ] 03 | `replay-03-progress.png` | Capturing X% progress |
...
| 페이지 | # | 파일명 | 캡처 대상 |
|---|---|---|---|
| Edit | - [ ] 00 | `edit-00-context-menu.png` | 데이터셋 우클릭 메뉴 — Edit / Augment / Merge / Delete |
...
| Episode Edit | - [ ] 01 | `episode-edit-01-panel.png` | 데이터셋 탭 — 에피소드 클릭 시 우측 EpisodePanel |
...
| Server | - [ ] 03 | `server-03-install-run.png` | 설치 / 실행 버튼 + 진행 로그 + 실행 중 상태 |
...
| Parameters | - [ ] 01 | `params-01-form.png` | Step 3 — Checkpoint Name + lr / batch_size / epochs 등 학습 폼 |
