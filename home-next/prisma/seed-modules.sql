...
INSERT INTO "Module" (
  ...
  ('robot_omx',            'OMX',                    'robot',     'ROBOTIS OMX (5-DOF arm + 1-DOF gripper, Dynamixel)',             0, true, false, false, 'module-robot_omx-{version}.tar.gz',                  ARRAY[]::TEXT[], NOW(), NOW()),
  ('robot_omy',            'OMY',                    'robot',     'ROBOTIS OMY (6-DOF arm, DYNAMIXEL-Y; OMY-3M / OMY-F3M + RH-P12-RN gripper)', 0, true, false, false, 'module-robot_omy-{version}.tar.gz',                  ARRAY[]::TEXT[], NOW(), NOW()),
  ('robot_ai_worker',      'AI Worker',              'robot',     'ROBOTIS AI Worker (FFW-BG2/SG2 dual 7-DOF arm, onboard Orin, remote SSH)', 0, true, false, false, 'module-robot_ai_worker-{version}.tar.gz',            ARRAY[]::TEXT[], NOW(), NOW()),
