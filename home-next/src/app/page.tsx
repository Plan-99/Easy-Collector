      ...
      <section className="py-24 md:py-32 lg:py-40" id="pricing">
        <div className="max-w-7xl mx-auto px-6">
          <div className="reveal text-center mb-16 md:mb-20">
            ...
            <p className="text-surface-400 text-lg">Free 플랜으로 시작하고, 필요할 때 확장하세요.</p>
          </div>
            ...
            <div className="reveal reveal-delay-1 bezel-card group hover:-translate-y-2 spring-transition">
              <div className="bezel-inner p-8 md:p-10 flex flex-col h-full">
                ...
                <ul className="space-y-3 mb-10 flex-1">
                  <li className="flex items-center gap-3 text-surface-300 text-[0.94rem]"><span className="text-emerald-400 flex-shrink-0">✓</span>로봇 1대 연결</li>
            ...
            <div className="reveal reveal-delay-2 relative group hover:-translate-y-2 spring-transition">
              ...
              <div className="bezel-card relative">
                <div className="bezel-inner p-8 md:p-10 flex flex-col h-full">
                  ...
                  <ul className="space-y-3 mb-10 flex-1">
                    <li className="flex items-center gap-3 text-surface-300 text-[0.94rem]"><span className="text-emerald-400 flex-shrink-0">✓</span>무제한 로봇 연결</li>
                  ...
                  <a href="mailto:contact@easytrainer.io" className="btn-pill justify-center bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/35 hover:-translate-y-0.5 text-sm">
                    문의하기
                    <span className="icon-circle bg-white/20">→</span>
                  </a>
                </div>
