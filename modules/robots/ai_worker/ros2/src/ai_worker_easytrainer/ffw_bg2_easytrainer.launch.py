#!/usr/bin/env python3
#
# EasyTrainer bringup for ROBOTIS AI Worker FFW-BG2 (dual 7-DOF arm + gripper).
#
...
_CONTROLLER_YAML = os.path.join(_HERE, 'ffw_bg2_easytrainer_controller.yaml')
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('ros2_control_type', default_value='ffw_bg2_follower'),
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([FindPackageShare('ffw_description'),
                              'urdf', model, 'ffw_bg2_follower.urdf.xacro']),
        ' ', 'use_sim:=', use_sim,
