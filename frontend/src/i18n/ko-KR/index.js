...
export default {
  ...
  trainStopBtn: '학습 중지',
  trainSaveBtn: '저장 후 종료',
  trainSaveConfirm: '지금 학습을 종료하고 현재까지 val loss가 가장 낮은 체크포인트를 저장할까요?',
  trainSaveRequested: '저장을 요청했습니다. 곧 학습이 종료되며 best 체크포인트가 저장됩니다.',
  trainSaveFailed: '{error}: 학습 저장에 실패했습니다.',
